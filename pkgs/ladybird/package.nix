...
let
  ...
  upstreamRev = envOr "LADYBIRD_REV" "90b790f8702a5d5c5a66ef02f8669da2838ca6e3";
...
stdenv.mkDerivation (finalAttrs: {
  pname = "ladybird";
  version = "0-unstable-${upstreamVersionDate}";

  src = fetchFromGitHub {
    owner = "LadybirdBrowser";
    repo = "ladybird";
    rev = upstreamRev;
    hash = upstreamSrcHash;
  };

  cargoDeps = rustPlatform.fetchCargoVendor {
    inherit (finalAttrs) src;
    hash = upstreamCargoHash;
  };
